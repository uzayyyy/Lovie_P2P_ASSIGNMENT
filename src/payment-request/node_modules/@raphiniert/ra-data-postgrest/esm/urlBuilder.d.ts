...
export declare const enum PostgRestSortOrder {
...
export declare const getOrderBy: (field: string, order: string, primaryKey: PrimaryKey, sortOrder?: PostgRestSortOrder) => string;
export {};
